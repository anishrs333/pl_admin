      ...
      <div className="card" style={{ padding: 0 }}>
        <div style={{ padding: '18px 22px 0' }}>
          <div className="search-wrap" style={{ marginBottom: 18 }}>
            ...
            <input className="form-control" style={{ paddingLeft: 36, maxWidth: 320 }} placeholder="Search colleges…" value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        </div>
        ...
        {isLoading ? <div className="loading-center"><div className="spinner" /></div> : (
          <div className="table-wrap" style={{ margin: 0 }}>
            <table>
              <thead>
                <tr><th>College</th><th>Contact</th><th>Mobile</th><th>Email</th><th>Actions</th></tr>
              </thead>
              <tbody>
                {colleges.map(c => (
                  <tr key={c.id}>
            ...
            {colleges.length === 0 && <div className="empty-state"><Building2 size={44} /><p>No colleges yet.</p></div>}
          </div>
        )}
      </div>
